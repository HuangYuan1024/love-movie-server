...
# 模板目录
$Template   = Join-Path $Root "build\scripts\scaffold\ServiceTemplate\generatetemplate-service"
...
@('generatetemplate-boot','generatetemplate-domain','generatetemplate-infrastructure','generatetemplate-interface','generatetemplate-application') | ForEach-Object {
...
# $dockerTemplate = Join-Path $Root "build\docker\generatetemplate-service.Dockerfile"
# $helmTemplate   = Join-Path $Root "build\helm\generatetemplate-service"
